...
const tourSchema = new mongoose.Schema(
  {
    ...
    priceDiscount: {
      ...
      validate: {
        validator: function (val) {
          //this keyword here points to curr doc only on NEW doc creation, but no on update
    ...
    startLocation: {
      //GeoJson format is used to specify geospatial data
      type: {
        type: String,
        default: 'Point',
        enum: ['Point'],
...
//virtual populate
//foreign and local fields is what needs to be identical to link two entities
...
//QUERY MIDDLEWARE
//find() hook will also have access to this keyword
//but this keyword would point to the query, not the document
